        ...
        <Menu as="div" class="relative inline-block text-left">
            <div>
                <MenuButton class="flex items-center">
                    <img src="https://randomuser.me/api/portraits/men/33.jpg" class="rounded-full w-8 mr-2"></img>
                    <small>Nathã Emanuel</small>
                    <ChevronDownIcon
...
<script setup>
import {Bars3Icon, ArrowRightStartOnRectangleIcon, UserIcon} from "@heroicons/vue/24/outline/index.js";
